...
const Explore_rooms = () => {
    ...
    return (
        <div>
            <div id='facilities_swiper' className="e_rooms container-fluid p-0">
                <div className='ps-4 sm:ps-87 md:ps-135 text-dark text-left'>
                    ...
                    <div>
                        <Swiper slidesPerView={3.3} navigation={true} modules={[Navigation]} spaceBetween={30} loop={true} className="mySwiper pt-92">
